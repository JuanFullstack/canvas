...
function Input() {
    ...
    return (
        ...
        <div className="input-group mt-4 ml-4  estilo-Input">
            ...
            <input type="text" className="form-control w-100" placeholder=" 2° PASO : aquí va el primer texto"   value={texto1} onChange={(e)=>{
            setTexto1(e.target.value)}} />
            
            <input type="text" className="form-control mt-3" placeholder="3° PASO : aquí el segundo si lo desea"   value={texto2} onChange={(e)=>{
